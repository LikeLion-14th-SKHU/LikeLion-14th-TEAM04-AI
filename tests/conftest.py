...
# 샘플 analysis raw dict — scripts/run_stage5.py 등에서도 직접 임포트하여 중복 정의를 방지한다.
SAMPLE_ANALYSIS_DICT: dict = {
    "visual": {
...
def sample_analysis() -> AnalysisResult:
    ...
    return AnalysisResult.model_validate(SAMPLE_ANALYSIS_DICT)
